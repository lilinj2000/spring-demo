package com.example.democonsulconsumer.client;

import com.example.democonsulconsumer.client.config.FeignConfig;
 ...
 *
 */
@FeignClient(value = "consul-provider",configuration = FeignConfig.class)
